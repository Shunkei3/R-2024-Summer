...
### Preparation
If you are entirely new to R and RStudio, these sections from the book "R for Data Science" might be helpful to read before the class. Each section is very brief. Also, don't worry about the code in the book.:
