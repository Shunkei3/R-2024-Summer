...
This is a one-week course designed as an introduction to R statistical software for incoming graduate students. R is the leading software used in Ph.D.-level econometric classes in APEC (APEC 8211-8214). For example, we extensively use R to conduct Monte Carlo simulations to understand the properties of different estimators and inference methods. In this course, we will go through the basics of R programming. Although the topics we can cover within five days are limited, I selected essential topics that would be directly helpful to establish a solid foundation for students’ R skills not only for first-year Ph.D. Econometrics classes, but also for personal research and future development of R skills.
