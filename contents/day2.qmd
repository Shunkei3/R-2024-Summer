...
+ [Section 18: Pipes](https://r4ds.had.co.nz/pipes.html) in the book of R for Data Science is a good introduction to the `%>%` operator of the `magrittr` package.
